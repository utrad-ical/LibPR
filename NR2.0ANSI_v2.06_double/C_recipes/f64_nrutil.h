...
double *f64_vector();
double **f64_matrix();
double **f64_submatrix();
double **f64_convert_matrix();
double ***f64_f3tensor();
double *f64_dvector();
double **f64_dmatrix();
int *f64_ivector();
int **f64_imatrix();
unsigned char *f64_cvector();
unsigned int *f64_lvector();
void f64_free_vector();
void f64_free_dvector();
void f64_free_ivector();
void f64_free_cvector();
void f64_free_lvector();
void f64_free_matrix();
void f64_free_submatrix();
void f64_free_convert_matrix();
void f64_free_dmatrix();
void f64_free_imatrix();
void f64_free_f3tensor();
